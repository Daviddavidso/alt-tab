...
(function () {
  ...
  /* «Планка, на которую равняемся»: чужие сайты-ориентиры, честно подписанные */
  var BM = {
    ru:{ navBench:'Ориентиры', navServices:'Услуги', benchTitle:'Планка, на которую равняемся',
         benchLead:'Честно: это чужие сайты. Мы держим их под рукой как линейку и по ним сверяем уровень каждого своего проекта.',
         benchNote:'За анимацией ходим сюда',
         work1Kind:'ювелирный дом', work1Desc:'Каталог украшений превратили в аудио-путешествие: пять историй, звук и типографика вместо привычной сетки товаров.',
         work2Kind:'команда разработчиков', work2Desc:'Одна страница, гигантский заголовок и ноль лишнего. Так выглядит уверенность в себе.',
         work3Kind:'бренд-агентство из Сингапура', work3Desc:'Наглая типографика и цвет, который ни с чем не спутаешь. Айдентика одинаково живёт в вебе и на упаковке.',
         work4Kind:'портфолио режиссёра', work4Desc:'Чёрный экран, рукописный логотип, видео вместо интерфейса. Когда убрано всё лишнее, работает каждый пиксель.' },
    en:{ navBench:'Benchmarks', navServices:'Services', benchTitle:'The bar we hold ourselves to',
         benchLead:'Straight up: these are other people’s sites. We keep them close as a ruler and measure every project of ours against them.',
         benchNote:'For animation we go here',
         work1Kind:'a jewellery house', work1Desc:'A jewellery catalogue turned into an audio journey: five tales, sound and typography instead of the usual product grid.',
         work2Kind:'a development duo', work2Desc:'One page, a giant headline and nothing else. That is what confidence looks like.',
         work3Kind:'a branding agency from Singapore', work3Desc:'Brash typography and a colour you cannot mistake for anything. The identity lives equally well on screen and on packaging.',
         work4Kind:'a director’s portfolio', work4Desc:'Black screen, handwritten logo, video instead of an interface. Strip everything away and every pixel starts working.' },
    de:{ navBench:'Maßstäbe', navServices:'Leistungen', benchTitle:'Die Latte, an der wir uns messen',
         benchLead:'Ehrlich: das sind fremde Websites. Wir behalten sie als Maßstab und vergleichen jedes eigene Projekt damit.',
         benchNote:'Für Animation gehen wir hierhin',
         work1Kind:'ein Schmuckhaus', work1Desc:'Ein Schmuckkatalog als Audioreise: fünf Geschichten, Klang und Typografie statt des üblichen Produktrasters.',
         work2Kind:'ein Entwickler-Duo', work2Desc:'Eine Seite, eine riesige Überschrift und sonst nichts. So sieht Selbstsicherheit aus.',
         work3Kind:'eine Brandingagentur aus Singapur', work3Desc:'Freche Typografie und eine unverwechselbare Farbe. Die Identität funktioniert im Web wie auf der Verpackung.',
         work4Kind:'das Portfolio eines Regisseurs', work4Desc:'Schwarzer Screen, handgeschriebenes Logo, Video statt Interface. Ohne Ballast arbeitet jeder Pixel.' },
    fr:{ navBench:'Références', navServices:'Services', benchTitle:'Le niveau qu’on vise',
         benchLead:'Soyons clairs : ce sont les sites des autres. On les garde sous la main comme une règle et on y compare chacun de nos projets.',
         benchNote:'Pour l’animation, on va ici',
         work1Kind:'une maison de joaillerie', work1Desc:'Un catalogue de bijoux transformé en voyage sonore : cinq récits, du son et de la typographie à la place de la grille produits.',
         work2Kind:'un duo de développeurs', work2Desc:'Une page, un titre géant et rien d’autre. Voilà à quoi ressemble la confiance.',
         work3Kind:'une agence de branding de Singapour', work3Desc:'Une typographie insolente et une couleur reconnaissable entre mille. L’identité vit aussi bien à l’écran que sur l’emballage.',
         work4Kind:'le portfolio d’un réalisateur', work4Desc:'Écran noir, logo manuscrit, vidéo à la place de l’interface. Une fois le superflu retiré, chaque pixel travaille.' },
    es:{ navBench:'Referentes', navServices:'Servicios', benchTitle:'El listón al que apuntamos',
         benchLead:'Con franqueza: son sitios ajenos. Los tenemos a mano como una regla y con ellos medimos cada proyecto nuestro.',
         benchNote:'Para animación vamos aquí',
         work1Kind:'una casa de joyería', work1Desc:'Un catálogo de joyas convertido en viaje sonoro: cinco relatos, sonido y tipografía en lugar de la típica retícula de productos.',
         work2Kind:'un dúo de desarrolladores', work2Desc:'Una página, un titular enorme y nada más. Así se ve la seguridad en uno mismo.',
         work3Kind:'una agencia de branding de Singapur', work3Desc:'Tipografía descarada y un color que no se confunde con nada. La identidad funciona igual en pantalla y en el envase.',
         work4Kind:'el portafolio de un director', work4Desc:'Pantalla negra, logo manuscrito, vídeo en vez de interfaz. Sin nada sobrante, cada píxel trabaja.' },
    it:{ navBench:'Riferimenti', navServices:'Servizi', benchTitle:'L’asticella che ci siamo dati',
         benchLead:'Diciamolo: sono siti altrui. Li teniamo a portata come un metro e ci misuriamo ogni nostro progetto.',
         benchNote:'Per l’animazione andiamo qui',
         work1Kind:'una maison di gioielli', work1Desc:'Un catalogo di gioielli trasformato in viaggio sonoro: cinque racconti, suono e tipografia al posto della solita griglia di prodotti.',
         work2Kind:'un duo di sviluppatori', work2Desc:'Una pagina, un titolo gigantesco e nient’altro. Ecco come appare la sicurezza.',
         work3Kind:'un’agenzia di branding di Singapore', work3Desc:'Tipografia sfacciata e un colore inconfondibile. L’identità vive allo stesso modo sul web e sulla confezione.',
         work4Kind:'il portfolio di un regista', work4Desc:'Schermo nero, logo scritto a mano, video al posto dell’interfaccia. Tolto il superfluo, ogni pixel lavora.' },
    pl:{ navBench:'Wzorce', navServices:'Usługi', benchTitle:'Poprzeczka, do której się równamy',
         benchLead:'Szczerze: to cudze strony. Trzymamy je pod ręką jak linijkę i po nich sprawdzamy poziom każdego swojego projektu.',
         benchNote:'Po animację chodzimy tutaj',
         work1Kind:'dom jubilerski', work1Desc:'Katalog biżuterii zamieniony w podróż dźwiękową: pięć opowieści, dźwięk i typografia zamiast zwykłej siatki produktów.',
         work2Kind:'duet programistów', work2Desc:'Jedna strona, gigantyczny nagłówek i zero zbędnego. Tak wygląda pewność siebie.',
         work3Kind:'agencja brandingowa z Singapuru', work3Desc:'Bezczelna typografia i kolor nie do pomylenia. Identyfikacja żyje tak samo w sieci i na opakowaniu.',
         work4Kind:'portfolio reżysera', work4Desc:'Czarny ekran, odręczne logo, wideo zamiast interfejsu. Gdy zniknie zbędne, pracuje każdy piksel.' },
    ro:{ navBench:'Repere', navServices:'Servicii', benchTitle:'Ștacheta la care ne raportăm',
         benchLead:'Sincer: sunt site-uri străine. Le ținem la îndemână ca pe o riglă și cu ele măsurăm fiecare proiect al nostru.',
         benchNote:'Pentru animație mergem aici',
         work1Kind:'o casă de bijuterii', work1Desc:'Un catalog de bijuterii transformat în călătorie sonoră: cinci povești, sunet și tipografie în locul grilei obișnuite de produse.',
         work2Kind:'un duo de dezvoltatori', work2Desc:'O pagină, un titlu uriaș și nimic în plus. Așa arată încrederea în sine.',
         work3Kind:'o agenție de branding din Singapore', work3Desc:'Tipografie obraznică și o culoare pe care nu o confunzi cu nimic. Identitatea trăiește la fel pe web și pe ambalaj.',
         work4Kind:'portofoliul unui regizor', work4Desc:'Ecran negru, logo scris de mână, video în loc de interfață. Când scoți tot ce e în plus, fiecare pixel lucrează.' },
    pt:{ navBench:'Referências', navServices:'Serviços', benchTitle:'A régua pela qual nos medimos',
         benchLead:'Sendo honestos: são sites dos outros. Guardamos eles por perto como uma régua e por eles conferimos o nível de cada projeto nosso.',
         benchNote:'Para animação, vamos aqui',
         work1Kind:'uma casa de joias', work1Desc:'Um catálogo de joias transformado em viagem sonora: cinco histórias, som e tipografia no lugar da grade de produtos de sempre.',
         work2Kind:'uma dupla de desenvolvedores', work2Desc:'Uma página, um título gigante e nada além. É assim que a confiança se parece.',
         work3Kind:'uma agência de branding de Singapura', work3Desc:'Tipografia atrevida e uma cor que não se confunde com nada. A identidade vive igual na web e na embalagem.',
         work4Kind:'o portfólio de um diretor', work4Desc:'Tela preta, logo manuscrito, vídeo no lugar da interface. Sem excesso, cada pixel trabalha.' }
  };
  Object.keys(BM).forEach(function(k){ Object.assign(TR[k]||{}, BM[k]); });
