...
(function () {
  ...
  /* секция «Наши работы» */
  var BM = {
    ru:{ navWorks:'Работы', navServices:'Услуги', worksTitle:'Наши работы',
         worksLead:'Проекты, которые мы собрали с нуля: дизайн, код, запуск. Открывайте и щупайте вживую.',
         work1Kind:'Ювелирный бренд, Италия', work1Desc:'Каталог украшений превратили в аудио-путешествие: пять историй со звуком и анимацией вместо привычной сетки товаров.',
         work2Kind:'Студия разработки', work2Desc:'Одна страница для команды разработчиков. Гигантская типографика, ноль лишнего, всё внимание на оффер.',
         work3Kind:'Бренд-агентство, Сингапур', work3Desc:'Сайт-витрина агентства. Наглая типографика и цвет, айдентика одинаково живёт в вебе и на упаковке.',
         work4Kind:'Портфолио режиссёра', work4Desc:'Чёрный экран, рукописный логотип, видео вместо интерфейса. Всё лишнее убрано, работает каждый пиксель.' },
    en:{ navWorks:'Work', navServices:'Services', worksTitle:'Our work',
         worksLead:'Projects we built from scratch: design, code, launch. Open them and try them for real.',
         work1Kind:'Jewellery brand, Italy', work1Desc:'A jewellery catalogue turned into an audio journey: five tales with sound and motion instead of the usual product grid.',
         work2Kind:'Development studio', work2Desc:'One page for a development team. Giant typography, nothing spare, all the attention on the offer.',
         work3Kind:'Branding agency, Singapore', work3Desc:'A showcase site for the agency. Brash typography and colour, an identity that lives equally on screen and on packaging.',
         work4Kind:'Director’s portfolio', work4Desc:'Black screen, handwritten logo, video instead of an interface. Everything spare is gone and every pixel works.' },
    de:{ navWorks:'Arbeiten', navServices:'Leistungen', worksTitle:'Unsere Arbeiten',
         worksLead:'Projekte, die wir von Grund auf gebaut haben: Design, Code, Launch. Öffnen und live ausprobieren.',
         work1Kind:'Schmuckmarke, Italien', work1Desc:'Ein Schmuckkatalog als Audioreise: fünf Geschichten mit Klang und Animation statt des üblichen Produktrasters.',
         work2Kind:'Entwicklungsstudio', work2Desc:'Eine Seite für ein Entwicklerteam. Riesige Typografie, nichts Überflüssiges, volle Aufmerksamkeit auf das Angebot.',
         work3Kind:'Brandingagentur, Singapur', work3Desc:'Eine Schaufenster-Site für die Agentur. Freche Typografie und Farbe, eine Identität für Web und Verpackung.',
         work4Kind:'Regisseur-Portfolio', work4Desc:'Schwarzer Screen, handgeschriebenes Logo, Video statt Interface. Ohne Ballast arbeitet jeder Pixel.' },
    fr:{ navWorks:'Projets', navServices:'Services', worksTitle:'Nos projets',
         worksLead:'Des projets qu’on a construits de zéro : design, code, lancement. Ouvrez-les et testez-les en vrai.',
         work1Kind:'Marque de joaillerie, Italie', work1Desc:'Un catalogue de bijoux transformé en voyage sonore : cinq récits avec du son et du mouvement à la place de la grille produits.',
         work2Kind:'Studio de développement', work2Desc:'Une page pour une équipe de développeurs. Typographie géante, rien de superflu, toute l’attention sur l’offre.',
         work3Kind:'Agence de branding, Singapour', work3Desc:'Un site vitrine pour l’agence. Typographie insolente et couleur, une identité qui vit à l’écran comme sur l’emballage.',
         work4Kind:'Portfolio de réalisateur', work4Desc:'Écran noir, logo manuscrit, vidéo à la place de l’interface. Le superflu retiré, chaque pixel travaille.' },
    es:{ navWorks:'Trabajos', navServices:'Servicios', worksTitle:'Nuestros trabajos',
         worksLead:'Proyectos que montamos desde cero: diseño, código, lanzamiento. Ábrelos y pruébalos en vivo.',
         work1Kind:'Marca de joyería, Italia', work1Desc:'Un catálogo de joyas convertido en viaje sonoro: cinco relatos con sonido y animación en lugar de la típica retícula de productos.',
         work2Kind:'Estudio de desarrollo', work2Desc:'Una página para un equipo de desarrolladores. Tipografía gigante, nada de sobra, toda la atención en la oferta.',
         work3Kind:'Agencia de branding, Singapur', work3Desc:'Un sitio escaparate para la agencia. Tipografía descarada y color, una identidad que vive en pantalla y en el envase.',
         work4Kind:'Portafolio de director', work4Desc:'Pantalla negra, logo manuscrito, vídeo en vez de interfaz. Sin nada sobrante, cada píxel trabaja.' },
    it:{ navWorks:'Lavori', navServices:'Servizi', worksTitle:'I nostri lavori',
         worksLead:'Progetti costruiti da zero: design, codice, lancio. Aprili e provali dal vivo.',
         work1Kind:'Brand di gioielli, Italia', work1Desc:'Un catalogo di gioielli trasformato in viaggio sonoro: cinque racconti con suono e animazione al posto della solita griglia di prodotti.',
         work2Kind:'Studio di sviluppo', work2Desc:'Una pagina per un team di sviluppatori. Tipografia gigantesca, niente di superfluo, tutta l’attenzione sull’offerta.',
         work3Kind:'Agenzia di branding, Singapore', work3Desc:'Un sito vetrina per l’agenzia. Tipografia sfacciata e colore, un’identità che vive sul web come sulla confezione.',
         work4Kind:'Portfolio di un regista', work4Desc:'Schermo nero, logo scritto a mano, video al posto dell’interfaccia. Tolto il superfluo, ogni pixel lavora.' },
    pl:{ navWorks:'Realizacje', navServices:'Usługi', worksTitle:'Nasze realizacje',
         worksLead:'Projekty zbudowane od zera: design, kod, start. Otwórz i sprawdź na żywo.',
         work1Kind:'Marka jubilerska, Włochy', work1Desc:'Katalog biżuterii zamieniony w podróż dźwiękową: pięć opowieści z dźwiękiem i animacją zamiast zwykłej siatki produktów.',
         work2Kind:'Studio developerskie', work2Desc:'Jedna strona dla zespołu programistów. Gigantyczna typografia, zero zbędnego, cała uwaga na ofercie.',
         work3Kind:'Agencja brandingowa, Singapur', work3Desc:'Strona-wizytówka agencji. Bezczelna typografia i kolor, identyfikacja żyje w sieci i na opakowaniu.',
         work4Kind:'Portfolio reżysera', work4Desc:'Czarny ekran, odręczne logo, wideo zamiast interfejsu. Bez zbędnego pracuje każdy piksel.' },
    ro:{ navWorks:'Proiecte', navServices:'Servicii', worksTitle:'Proiectele noastre',
         worksLead:'Proiecte construite de la zero: design, cod, lansare. Deschide-le și încearcă-le live.',
         work1Kind:'Brand de bijuterii, Italia', work1Desc:'Un catalog de bijuterii transformat în călătorie sonoră: cinci povești cu sunet și animație în locul grilei obișnuite de produse.',
         work2Kind:'Studio de dezvoltare', work2Desc:'O pagină pentru o echipă de dezvoltatori. Tipografie uriașă, nimic în plus, toată atenția pe ofertă.',
         work3Kind:'Agenție de branding, Singapore', work3Desc:'Un site vitrină pentru agenție. Tipografie obraznică și culoare, o identitate care trăiește pe web și pe ambalaj.',
         work4Kind:'Portofoliu de regizor', work4Desc:'Ecran negru, logo scris de mână, video în loc de interfață. Fără nimic în plus, fiecare pixel lucrează.' },
    pt:{ navWorks:'Projetos', navServices:'Serviços', worksTitle:'Nossos projetos',
         worksLead:'Projetos que montamos do zero: design, código, lançamento. Abra e teste ao vivo.',
         work1Kind:'Marca de joias, Itália', work1Desc:'Um catálogo de joias transformado em viagem sonora: cinco histórias com som e animação no lugar da grade de produtos de sempre.',
         work2Kind:'Estúdio de desenvolvimento', work2Desc:'Uma página para um time de desenvolvedores. Tipografia gigante, nada sobrando, toda a atenção na oferta.',
         work3Kind:'Agência de branding, Singapura', work3Desc:'Um site vitrine para a agência. Tipografia atrevida e cor, uma identidade que vive na web e na embalagem.',
         work4Kind:'Portfólio de diretor', work4Desc:'Tela preta, logo manuscrito, vídeo no lugar da interface. Sem excesso, cada pixel trabalha.' }
  };
